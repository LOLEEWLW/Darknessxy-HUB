--[[
    ...
    Sistema de Key com visual clean (preto/branco)
...
-- ==========================================
-- SISTEMA DE KEY (LOGIN) - VISUAL CLEAN
-- ==========================================
...
-- Frame de fundo escuro com gradiente
...
-- Gradiente (usando um ImageLabel com gradiente feito no momento)
local gradient = Instance.new("ImageLabel")
gradient.Size = UDim2.new(1, 0, 1, 0)
gradient.BackgroundTransparency = 1
gradient.Image = "rbxassetid://1461692487" -- gradiente preto-vermelho
...
-- Boca (arco feliz) usando um Frame com ângulo
...
-- ==========================================
-- BARRA DE ABAS (8 ABAS - SUBSTITUÍDO COMBAT POR AIMBOT)
-- ==========================================
...
local TabAimbotBtn = createTabButton("AIMBOT", 0.5)   -- substitui Combat
...
showPage(pages.AimbotPage) -- agora a primeira é Aimbot
...
-- ==========================================
-- PÁGINAS (GLITCH, ESP, FLY, HITBOX, AIMBOT, UTILS, OTIMIZ, VISUAL)
-- ==========================================
...
-- Frame para a lista de players (com ScrollingFrame)
...
-- ==========================================
-- PÁGINA UTILS (com Auto Click, Fast Attack, Misc)
-- ==========================================
...
-- ==========================================
-- LOGIN (com destruição do Background)
-- ==========================================
LoginBtn.MouseButton1Click:Connect(function()
    if KeyInput.Text == CorrectKey then
        -- Destrói o tema de fundo (rosto feliz + partículas)
